...
void elective()//学生选课主函数
{
    ...
    switch(i)
    {
    case(1):system("clear");cheak();break;
    case(2):system("clear");hcheak();break;
    case(3):system("clear");break;
    }
}
...
void index_info()//信息主函数
{
    ...
    switch(i)
    {
    case(1):system("clear");list_course();break;
    case(2):system("clear");save_all();break;
    case(3):system("clear");break;
    }
}
void teacher_manage()
{
    ...
    if(p==12345678)
    {
        ...
        scanf("%d",&i);
        switch (i) {
            case (1):system("clear");management_course();break;
            case (2):system("clear");list_course();break;
            case (3):system("clear");management_student();break;
            case (4):system("clear");list_student();break;
